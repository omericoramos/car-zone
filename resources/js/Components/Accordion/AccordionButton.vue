    ...
    <div>
        <div id="accordion-text-01" role="region" aria-labelledby="accordion-title-01"
            ...
            <ul class="overflow-hidden">
                <LiAccordion>Cadastrar carro</LiAccordion>
                <LiAccordion>Cadastrar cliente</LiAccordion>
            </ul>
        </div>
    </div>
</template>